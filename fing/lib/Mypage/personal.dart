        ...
        child: Center(
          child: Container(
            constraints: BoxConstraints(
              ...
              child: Text('''
핑퐁(이하 ‘회사’)는 핑 서비스 기획부터 종료까지 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 ‘정보통신망법’), 개인정보보호법 등 국내의 개인정보 보호 법령을 철저히 준수합니다.
1. 수집하는 개인정보
회사는 이용자(회원, 비회원 포함)로부터 서비스 이용을 위해 필요한 최소한의 개인정보를 수집하여 처리하고 있습니다.
회원가입 시
구글 아이디와 카카오 아이디를 사용하여 로그인 가능하며 개인정보(카카오 프로필, 이메일)를 수집합니다.
본인인증 시
이름, 생년월일, 이메일, 성별, 통신사업자, 내/외국인여부, 암호화된 이용자 확인값(CI), 중복가입확인정보(DI)를 수집합니다.
서비스 이용 시
단말기정보(모델명, 이동통신사 정보, OS정보, 언어 및 국가정보, 화면사이즈, 디바이스 아이디 등), IP주소, 쿠키, 방문일시, 위치정보, 부정이용기록, 서비스 이용 기록 등의 정보가 생성되어 수집될 수 있습니다.
구체적으로 서비스 이용 과정에서 이용자에 관한 정보를 자동화된 방법으로 생성하여 이를 수집하거나, 이용자 기기의 고유한 정보를 원래의 값을 확인하지 못하도록 안전하게 변환하여 수집합니다. 서비스 이용 과정에서 위치정보가 수집될 수 있으며, 핑퐁에서 제공하는 위치기반 서비스에 대해서는 ‘위치정보 이용약관’에서 자세하게 규정하고 있습니다.
회사는 회원가입 과정 또는 비회원의 서비스 이용 과정에서 최소한의 정보만을 수집하기 때문에 개별 서비스 이용, 이벤트 응모 및 경품 신청 등의 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.
고객 상담 시
고객 상담, 민원 접수 및 처리에 필요한 개인정보 (이름, 연락처, 이메일) 및 상담 내용을 수집할 수 있습니다.
유료상품 구매 시
상품의 구매 및 서비스 이용 과정에서 아래와 같은 정보를 수집할 수 있습니다.

수집하는 개인정보 항목
용도
이름,전화번호,주소,이메일,
카카오 아이디
상품구매 및 어플리케이션 이용 문의, 약관의 주요 변경사항, 기타 마케팅 정보 등을 제공
카드사명,카드번호,유효기간 등
신용카드 결제로 상품 구매시
휴대폰번호
현금영수증 신청 시
...
2. 개인정보 수집 방법
회사는 회원가입 및 서비스 이용 과정에서 이용자로부터 직접 입력 받는 방식으로 필요한 최소한의 개인정보를 수집하며, 상품구매 등의 유료 서비스 이용 과정에서 추가적인 정보를 수집하고 있습니다. 오프라인으로 진행되는 이벤트 및 세미나 등에서 서면을 통해 개인정보를 수집할 수 있으며, 고객센터 상담 과정에서 웹 페이지, 메일, 팩스, 전화 등을 통해서도 수집할 수 있습니다.
...
• 법령 및 핑퐁 이용약관을 위반하는 이용자에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재, 계정도용 및 부정거래 방지, 약관 개정 등의 고지사항 전달, 분쟁조정을 위한 기록 보존, 민원처리 등 이용자 보호 및 서비스 운영을 위하여 개인정보를 이용합니다.
• 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산, 상품 예약, 컨텐츠 제공, 구매 및 요금 결제, 물품배송 또는 청구지 등 발송, 금융거래 본인 인증 및 금융서비스 등을 위하여 개인정보를 이용합니다.
...
• 회사는 이용자의 사전 동의 없이 개인정보를 외부에 제공하지 않습니다. 단, 이용자가 외부 제휴사의 서비스를 이용하기 위하여 개인정보 제공에 직접 동의를 한 경우, 그리고 관련 법령에 의거해 핑퐁에 개인정보 제출 의무가 발생한 경우, 이용자의 생명이나 안전에 급박한 위험이 확인되어 이를 해소하기 위한 경우에 한하여 개인정보를 제공하고 있습니다.
...
• 참고로 회사는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.
7. 이용자 및 법정대리인의 권리와 행사 방법
• 이용자는 언제든지 ‘핑퐁> 설정’에서 자신의 개인정보를 조회하거나 수정할 수 있습니다.
• 이용자는 언제든지 ‘회원탈퇴’ 등을 통해 개인정보의 수집 및 이용 동의를 철회할 수 있으며, 수집된 개인정보는 철회 즉시 파기됩니다.
• 회원탈퇴는 ‘핑퐁 서비스 앱 메뉴 [≡] > [설정] > [서비스 탈퇴]’에서 할 수 있습니다.
...
핑퐁 이용자의 개인정보 관련 문의사항 및 불만 처리 등을 위하여 아래와 같이 개인정보 보호책임자 및 담당자를 지정하고 있습니다.

개인정보 보호책임자
개인정보 관리담당자
- 성명: 조민수- 연락처: 010-5826-2205,
- sncalphs@gmail.com
- 성명: 정세연- 연락처: 010-5341-9168,
- wjdtpdus828@naver.com 
...
9. 본 개인정보처리방침의 적용 범위
• 본 개인정보처리방침은 회사의 브랜드 중 하나인 ‘핑퐁’ 및 관련 제반 서비스(모바일 웹/앱 포함)에 적용되며, 다른 브랜드로 제공되는 서비스에 대해서는 별개의 개인정보처리방침이 적용될 수 있습니다.
• 핑퐁에 링크되어 있는 다른 회사의 웹사이트에서 개인정보를 수집하는 경우, 이용자 동의 하에 개인정보가 제공된 이후에는 본 개인정보처리방침이 적용되지 않습니다.
10. 개정 전 고지 의무
...
• 공고일자: 2022년 9월 01일
• 시행일자: 2022년 9월 01일
이전의 개인정보 처리방침은 위에 적힌 담당자에게 메일을 보내 확인하시기 바랍니다
'''),
              )
              )
              )
