      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            height: 300,
            width: 300,
            child: Image.asset('images/echobag.png', fit: BoxFit.fill,)
          ),
          Container(
            width: 300,
            child: Column(
              children: [
                Container(
                  ...
                  child: Text('Fing Echobag',style: TextStyle(
                    fontSize: 25,
                    fontWeight: FontWeight.bold
                  ),),
                ),
                Container(
                  ...
                  child: Text('KRW 15,000',style: TextStyle(
                    fontSize: 20,
                  ),),
                ),
                Container(
