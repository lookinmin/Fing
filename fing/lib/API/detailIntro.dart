...
// api 호출
Future<List<DetailIntro>> fetchDetailIntro({required String contentId}) async {
...
class _DetailIntroWidgetState extends State<DetailIntroWidget> {
  ...
  void initState() {
    super.initState();
    // 여기 적혀 있는 변수들 다 넣어야됨
    futureDetailIntro = fetchDetailIntro(contentId: "506545");
  }
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, index) => Card(
                          ...
                          child: ListTile(
                            ...
                            title: Text(detailIntro_model[index]
                                .eventstartdate
                                .toString()),
                            subtitle: Text(detailIntro_model[index]
                                .eventenddate
                                .toString()),
                          ))));
            }
