...
// api 호출
Future<List<SearchStay>> fetchSearchStay(
    {required String arrange,
    required String areaCode,
    required String sigunguCode}) async {
  ...
  queryParams +=
      "&arrange=$arrange&areaCode=$areaCode&sigunguCode=$sigunguCode";
...
class _SearchStayWidgetState extends State<SearchStayWidget> {
  ...
  void initState() {
    ...
    // 여기 적혀 있는 변수들 다 넣어야됨
    futureSearchStay =
        fetchSearchStay(arrange: "A", areaCode: "1", sigunguCode: "1");
  }
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, index) => Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle:
                              Text(searchstay_model[index].addr1.toString()),
                        ))));
