...
// api 호출
Future<List<CategoryCode>> fetchCategoryCode({required String contentTypeId, required String cat1, required String cat2, required String cat3}) async {
  ...
  queryParams += "&contentTypeId=$contentTypeId&cat1=$cat1&cat2=$cat2&cat3=$cat3";
    ...
    return FutureBuilder<List<CategoryCode>>(
      ...
      builder:(context,snapshot){
        if(snapshot.hasData){
          ...
          List<Item> categorycode_model = snapshot.data![0].response!.body!.items!.item!;
          ...
          return Container(
            ...
            itemBuilder:(BuildContext context, index)=>Card(
              ...
              child:ListTile(
                ...
                title:Text(categorycode_model[index].name.toString()),
                subtitle:Text(categorycode_model[index].code.toString()),
              )
            )
          ));
